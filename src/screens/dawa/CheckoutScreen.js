                ...
                <ScrollView style={styles.container}>
                    ...
                    <View style={styles.section}>
                        <View style={styles.group}>
                            <View style={styles.sectionPart} >
                                <Block row style={{ paddingHorizontal: 10 }} >
                                     <MaterialCommunityIcons name="human" size={18} style={{ marginRight: 10 }} />
                                     <View>
                                            <Txt>Meet at door</Txt>
                                            <Txt>Add delivery instructions </Txt>
                                        </View>
                                </Block>
                                <View style={{ backgroundColor: 'lightgray', padding: 10, borderRadius: 10, marginLeft: 10 }}>
                                    <Txt >Edit</Txt>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.group}>
                            <Block row style={{ marginLeft: 15 }} >
                                <MaterialCommunityIcons name="bike-fast" size={18} style={{ marginRight: 10 }} />
                                <Txt style={styles.buttonText}>

...
import { ActivityIndicator, Keyboard, KeyboardAvoidingView, View, 
  Dimensions, StyleSheet, ScrollView , Alert} from 'react-native'
        ...
        <Block padding={[80,theme.sizes.base * 2]}>
          ...
          <Block middle style={{paddingVertical:40}}>
            <Input
              ...
              // onChangeText={(email) => this.onInputChanged({ email})}
            />  
            <Input
              secure
              label="Mot de passe"

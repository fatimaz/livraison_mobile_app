...
import {addToCart, addCartItems, editCartItems, DeleteCart, fetchMyCart, fetchProducts } from '../../actions';
...
class ProductsList extends Component {
    ...
    incrementHalder = (item) => {
        ...
        const text = 'increase';
        const user = 1;
         this.props.addToCart(cart_id,product_id,count, cost)
...
export default connect(mapStateToProps, { addToCart, addCartItems, editCartItems, DeleteCart, fetchMyCart, fetchProducts })(ProductsList);
